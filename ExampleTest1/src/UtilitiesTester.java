public class UtilitiesTester
{
    public static void main(String[] args) {
        ...
        System.out.println(u.getWinnerOfRPSGame("Alan", 'R', "Mark", 'R'));
        System.out.println(u.getWinnerOfRPSGame("Alan", 'R', "Mark", 'P'));
        System.out.println(u.getWinnerOfRPSGame("Alan", 'R', "Mark", 'S'));
        System.out.println(u.getWinnerOfRPSGame("Alan", 'P', "Mark", 'R'));
        System.out.println(u.getWinnerOfRPSGame("Alan", 'P', "Mark", 'P'));
        System.out.println(u.getWinnerOfRPSGame("Alan", 'P', "Mark", 'S'));
        System.out.println(u.getWinnerOfRPSGame("Alan", 'S', "Mark", 'R'));
        System.out.println(u.getWinnerOfRPSGame("Alan", 'S', "Mark", 'P'));
        System.out.println(u.getWinnerOfRPSGame("Alan", 'S', "Mark", 'S'));
        
        System.out.println(u.getBMI(68, 196));
    }
}
